...
class lieudate1 extends StatefulWidget {
  late Accident accident;
  lieudate1({required this.accident,});

  @override
  _lieudate1State createState() => _lieudate1State(accident:accident);
}
class _lieudate1State extends State<lieudate1> {
  late Accident accident;
  _lieudate1State({required this.accident,});
                      ...
                      if (isValid == false) {
                       // setState((){//});
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => LRadio(accident:accident)),
                        );
                      }},
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => assure(accident:accident)),
                          );
                        },
                        color: Colors.red,
                        textColor: Colors.white,
